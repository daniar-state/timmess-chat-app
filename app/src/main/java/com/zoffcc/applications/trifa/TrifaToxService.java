...
import static com.zoffcc.applications.trifa.MainActivity.receivers;
...
public class TrifaToxService extends Service
{
    ...
    public boolean isReceiverRegistered(HeadsetStateReceiver receiver) {
            ...
            try
            {
                ...
                Thread t = new Thread()
                {
                    ...
                    public void run()
                    {
                        ...
                        try
                        {
                            if(isReceiverRegistered(receiver1)){
                        ...
                        try
                        {
                            if(isReceiverRegistered(receiver2)){
                        ...
                        try
                        {
                            if(isReceiverRegistered(receiver3)){
                        ...
                        try
                        {
                            if(isReceiverRegistered(receiver4)){
    ...
    void tox_thread_start_fg()
    {
        ...
        ToxServiceThread = new Thread()
        {
            ...
            public void run()
            {
                ...
                {
                    tox_self_set_name("Timmess " + my_tox_id_local.substring(0, 4));
                    global_my_name = ("Timmess " + my_tox_id_local.substring(0, 4));
                    Log.i(TAG, "AAA:005");
                }
                ...
                {
                    tox_self_set_status_message("this is Timmess");
                    global_my_status_message = "this is Timmess";
                    Log.i(TAG, "AAA:010");
                }
                Log.i(TAG, "AAA:011");
