...
public class HelperToxNotification
{
    ...
    static Notification tox_notification_setup(Context c, NotificationManager nmn2)
    {
        ...
        notification_view.setTextViewText(R.id.title, "Timmess Service: " + "OFFLINE");
    ...
    static void tox_notification_change(Context c, NotificationManager nmn2, int a_TOXCONNECTION, String message)
    {
        ...
        if (bootstrapping)
        {
            ...
            notification_view.setTextViewText(R.id.title, "Timmess Service: " + "Bootstrapping" + " " + message);
        }
        else
        {
            ...
            if (a_TOXCONNECTION == 0)
            {
                ...
                notification_view.setTextViewText(R.id.title, "Timmess Service: " + "OFFLINE" + " " + message);
            }
            else
            {
                if (a_TOXCONNECTION == 1)
                {
                    ...
                    notification_view.setTextViewText(R.id.title, "Timmess Service: " + "ONLINE [TCP]" + " " + message);
                ...
                else // if (a_TOXCONNECTION__f == 2)
                {
                    ...
                    notification_view.setTextViewText(R.id.title, "Timmess Service: " + "ONLINE [UDP]" + " " + message);
                    // get_network_connections();
                }
            }
        }
