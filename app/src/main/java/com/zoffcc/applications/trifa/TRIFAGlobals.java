...
public class TRIFAGlobals
{
    ...
    final static long AVATAR_INCOMING_MAX_BYTE_SIZE = 20 * 1024 * 1024; // limit incoming avatars at 20MByte size
    final static long AVATAR_SELF_MAX_BYTE_SIZE = 20 * 1024 * 1024; // limit incoming avatars at 20MByte size
