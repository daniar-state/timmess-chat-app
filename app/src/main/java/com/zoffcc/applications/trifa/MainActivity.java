...
public class MainActivity extends AppCompatActivity
{
    ...
    private static final int REQUEST_CODE_OVERLAY = 987;
    // --------- global config ---------
    // --------- global config ---------
    // --------- global config ---------
    ...
    public static List<HeadsetStateReceiver> receivers = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        PrimaryDrawerItem item1 = new PrimaryDrawerItem().withIdentifier(1).withName(
                R.string.MainActivity_profile).withIcon(R.drawable.ic_profile).withTextColorRes(R.color.md_fdfdfd);
        PrimaryDrawerItem item2 = new PrimaryDrawerItem().withIdentifier(2).withName(
                R.string.MainActivity_settings).withIcon(R.drawable.ic_settings).withTextColorRes(R.color.md_fdfdfd);
        PrimaryDrawerItem item3 = new PrimaryDrawerItem().withIdentifier(3).withName(
                R.string.MainActivity_logout_login).withIcon(R.drawable.ic_exit).withTextColorRes(R.color.md_fdfdfd);

        PrimaryDrawerItem item_tor = new PrimaryDrawerItem().withIdentifier(7).withName(
            R.string.MainActivity_tor).withIcon(R.drawable.ic_tor).withTextColorRes(R.color.md_fdfdfd);
        PrimaryDrawerItem item_market = new PrimaryDrawerItem().withIdentifier(8).withName(
            R.string.MainActivity_market).withIcon(R.drawable.ic_market).withTextColorRes(R.color.md_fdfdfd);
        PrimaryDrawerItem item_arka = new PrimaryDrawerItem().withIdentifier(9).withName(
            R.string.MainActivity_arka).withIcon(R.drawable.ic_exit).withTextColorRes(R.color.md_fdfdfd);

        PrimaryDrawerItem item4 = new PrimaryDrawerItem().withIdentifier(4).withName(
                R.string.MainActivity_maint).withIcon(R.drawable.ic_settings).withTextColorRes(R.color.md_fdfdfd);
...
//                R.string.MainActivity_about).withIcon(GoogleMaterial.Icon.gmd_info);
        PrimaryDrawerItem item6 = new PrimaryDrawerItem().withIdentifier(6).withName(
                R.string.MainActivity_exit).withIcon(R.drawable.ic_exit).withTextColorRes(R.color.md_fdfdfd);
