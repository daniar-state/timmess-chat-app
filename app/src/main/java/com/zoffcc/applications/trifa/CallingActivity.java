...
public class CallingActivity extends AppCompatActivity implements CameraWrapper.CamOpenOverCallback, SensorEventListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        final Drawable d3 = new IconicsDrawable(this).icon(GoogleMaterial.Icon.gmd_phone).backgroundColor(
                Color.TRANSPARENT).color(Color.parseColor("#A0FF0000")).sizeDp(40); //$NON-NLS-1$
        decline_button.setImageDrawable(d3);
        // #AARRGGBB

        final Drawable d4 = new IconicsDrawable(this).icon(GoogleMaterial.Icon.gmd_phone).backgroundColor(
                Color.TRANSPARENT).color(Color.parseColor("#EF088A29")).sizeDp(40); //$NON-NLS-1$
